...
const CampaignDetail = () => {
  ...
  const donationTransactions = [
    ...
    { donor: 'Binayak', amount: 300, date: '2024-09-08' },
    { donor: 'Mohan', amount: 1000, date: '2024-09-08' },
  ];

  const recipientTransactions = [
    { recipient: 'Recipient A', amount: 9000, date: '2024-09-08' },
    { recipient: 'Recipient B', amount: 900, date: '2024-09-08' },
  ];

  const data = {
    name: 'Helping Hands', // Organization in the middle
    children: [
      {
        name: 'Donors',
        children: [
          { name: 'Anish', amountDonated: 5000 },
          { name: 'Binayak', amountDonated: 300 },
      ...
      },
      {
        name: 'Recipients',
        children: [
          { name: 'Furniture', amountReceived: 9000 },
          { name: 'Stationery', amountReceived: 900 },
        ],
      },
    ],
  };
